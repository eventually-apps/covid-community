...
namespace CovidCommunity.Api.Migrations
{
    ...
    [Migration("20200419182632_AddNullableFulfillmentDate")]
    partial class AddNullableFulfillmentDate
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CovidCommunity.Api.Domains.Location", b =>
                {
                    ...
                    b.Property<long>("LocationOwnerId")
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("CovidCommunity.Api.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("CovidCommunity.Api.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("CovidCommunity.Api.Authorization.Users.User", b =>
                {
                    ...
                    b.HasOne("CovidCommunity.Api.Domains.Location", "UserLocation")
                        .WithMany("Users")
